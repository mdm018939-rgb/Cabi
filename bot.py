...
COUNTRY_CODES = {
    ...
    "263": "🇿🇼 Zimbabwe",
    "225": "🇨🇮 Côte d'Ivoire", "262": "🇷🇪 Réunion / Mayotte", "297": "🇦🇼 Aruba",
    "298": "🇫🇴 Faroe Islands", "299": "🇬🇱 Greenland", "350": "🇬🇮 Gibraltar",
    "590": "🇬🇵 Guadeloupe", "594": "🇬🇫 French Guiana", "596": "🇲🇶 Martinique",
    "599": "🇨🇼 Curaçao"
}
...
def detect_service(message_text):
    ...
    skip = {"Your", "The", "This", "Code", "OTP", "PIN", "SMS", "From", "Dear", "Hello", "Please", "Use", "Don", "Not", "Share", "New", "Account", "For", "With", "You", "Has", "Been", "Are", "Was", "That", "Have", "Will", "Can", "Get", "Our", "One", "Time", "Enter", "Verify", "Login", "Sign", "App", "Now", "Click", "Here", "Link", "Sent", "Send"}
            ...
            if res_data.get("meta", {}).get("code") == 200:
                ...
                for otp in otps_list:
                    ...
                    if otp_id and otp_id not in sent_otp_ids:
                        ...
                        markup.row(
                            telebot.types.InlineKeyboardButton("Get Number", url="https://t.me/SMSTOSMSBOT?start=start"),
                            telebot.types.InlineKeyboardButton("Join Channel", url="https://t.me/+LZrutZRrpbRkNDVl")
                        )
